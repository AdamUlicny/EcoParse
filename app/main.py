...
from app.tabs import (
    ...
    t5_results_tab,
    t6_manual_verification_tab, # Import the new tab
)
...
tab1, tab2, tab3, tab4, tab5, tab6 = st.tabs([
    ...
    "4. Run Extraction",
    "5. View Results",
    "6. Manual Verification" # Add tab title
])

with tab1:
    t1_upload_pdf_tab.display()
with tab2:
    t2_species_id_tab.display()
with tab3:
    t3_configure_extraction_tab.display()
with tab4:
    t4_run_extraction_tab.display()
with tab5:
    t5_results_tab.display()
with tab6: # Add the display call for the new tab
    t6_manual_verification_tab.display()