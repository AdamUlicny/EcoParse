...
def initialize_session():
    """Initializes all session state variables on the very first run."""
    if "session_initialized" in st.session_state:
        return
    
    # Initialize all keys with default values
    reset_session() # Call reset to set everything up
    
    # Set non-data defaults that don't change on reset
